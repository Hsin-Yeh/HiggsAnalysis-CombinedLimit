...
#include "../interface/RooModDijetOrd2ForDiPhotonsBinPdf.h"
...
ClassImp(RooModDijetOrd2ForDiPhotonsBinPdf)
//---------------------------------------------------------------------------
RooModDijetOrd2ForDiPhotonsBinPdf::RooModDijetOrd2ForDiPhotonsBinPdf(const char *name, const char *title,
								     RooAbsReal& _th1x,  
								     RooAbsReal& _p1, RooAbsReal& _p2, RooAbsReal& _p3, RooAbsReal& _p4, RooAbsReal& _p5) :
...
//---------------------------------------------------------------------------
RooModDijetOrd2ForDiPhotonsBinPdf::RooModDijetOrd2ForDiPhotonsBinPdf(const RooModDijetOrd2ForDiPhotonsBinPdf& other, const char* name) :
...
//---------------------------------------------------------------------------
void RooModDijetOrd2ForDiPhotonsBinPdf::setTH1Binning(TH1* _Hnominal){
...
//---------------------------------------------------------------------------
void RooModDijetOrd2ForDiPhotonsBinPdf::setRelTol(double _relTol){
  relTol = _relTol;
}
//---------------------------------------------------------------------------
void RooModDijetOrd2ForDiPhotonsBinPdf::setAbsTol(double _absTol){
  absTol = _absTol;
}
//---------------------------------------------------------------------------
Double_t RooModDijetOrd2ForDiPhotonsBinPdf::evaluate() const
{
  ...
  ModDijetOrd2ForDiPhotonsFunction func;
  double params[5];
  params[0] = p1;
  params[1] = p2;
  params[2] = p3;
...
// //---------------------------------------------------------------------------
Int_t RooModDijetOrd2ForDiPhotonsBinPdf::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName) const{
  if (matchArgs(allVars, analVars, th1x)) return 1;
  return 0;
}

// //---------------------------------------------------------------------------
Double_t RooModDijetOrd2ForDiPhotonsBinPdf::analyticalIntegral(Int_t code, const char* rangeName) const{
  ...
  if (code==1 && iBinMin<=0 && iBinMax>=xBins){
    ...
    cout << "WARNING IN RooModDijetOrd2ForDiPhotonsBinPdf: integration code is not correct" << endl;
