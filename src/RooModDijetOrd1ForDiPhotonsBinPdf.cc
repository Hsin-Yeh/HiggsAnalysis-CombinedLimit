...
#include "../interface/RooModDijetOrd1ForDiPhotonsBinPdf.h"
...
ClassImp(RooModDijetOrd1ForDiPhotonsBinPdf)
//---------------------------------------------------------------------------
RooModDijetOrd1ForDiPhotonsBinPdf::RooModDijetOrd1ForDiPhotonsBinPdf(const char *name, const char *title,
						       RooAbsReal& _th1x,  
...
//---------------------------------------------------------------------------
RooModDijetOrd1ForDiPhotonsBinPdf::RooModDijetOrd1ForDiPhotonsBinPdf(const RooModDijetOrd1ForDiPhotonsBinPdf& other, const char* name) :
...
//---------------------------------------------------------------------------
void RooModDijetOrd1ForDiPhotonsBinPdf::setTH1Binning(TH1* _Hnominal){
...
//---------------------------------------------------------------------------
void RooModDijetOrd1ForDiPhotonsBinPdf::setRelTol(double _relTol){
  relTol = _relTol;
}
//---------------------------------------------------------------------------
void RooModDijetOrd1ForDiPhotonsBinPdf::setAbsTol(double _absTol){
  absTol = _absTol;
}
//---------------------------------------------------------------------------
Double_t RooModDijetOrd1ForDiPhotonsBinPdf::evaluate() const
{
  ...
  ModDijetOrd1ForDiPhotonsFunction func;
  double params[4];
  params[0] = p1;
  params[1] = p2;
  params[2] = p3;
...
// //---------------------------------------------------------------------------
Int_t RooModDijetOrd1ForDiPhotonsBinPdf::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName) const{
  if (matchArgs(allVars, analVars, th1x)) return 1;
  return 0;
}

// //---------------------------------------------------------------------------
Double_t RooModDijetOrd1ForDiPhotonsBinPdf::analyticalIntegral(Int_t code, const char* rangeName) const{
  ...
  if (code==1 && iBinMin<=0 && iBinMax>=xBins){
    ...
    cout << "WARNING IN RooModDijetOrd1ForDiPhotonsBinPdf: integration code is not correct" << endl;
